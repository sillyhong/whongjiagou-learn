...
require('child_process').exec("npm config get prefix", function (err, stdout, stderr) {
    ...
    // require(webpackPath);
    require('/usr/local/lib/node_modules/webpack-cli/bin/webpack.js');
    // require('/Users/silly/Documents/珠峰架构/zhufengjiagou-learn/35.webpack/node_modules/webpack-cli/bin/webpack.js');
});